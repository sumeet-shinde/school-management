...
import {
  deleteTeachersDataRequest,
  getTeachersDataRequest,
  getTeachersDataRequestName,
  getTeachersDataRequestPage,
} from "../Redux/Teachers/action";
  ...
  return (
    <>
      ...
      <Table style={{ margin: "auto", width: "1200px" }}>
        <thead>
          <tr>
            <th style={{ border: "1px solid", padding: "1%" }}>Name</th>
            <th style={{ border: "1px solid", padding: "1%" }}>Gender</th>
            <th style={{ border: "1px solid", padding: "1%" }}>Age</th>
            <th style={{ border: "1px solid", padding: "1%" }}>Edit</th>
            <th style={{ border: "1px solid", padding: "1%" }}>Delete</th>
            <th style={{ border: "1px solid", padding: "1%" }}>Show Classes</th>
          </tr>
        </thead>
        ...
        <tbody>
          {teachers.map((e, id) => {
            return (
              <tr key={id}>
                <td style={{ border: "1px solid", padding: "1%" }}>{e.name}</td>
                <td style={{ border: "1px solid", padding: "1%" }}>
                  {e.gender}
                </td>
                <td style={{ border: "1px solid", padding: "1%" }}>{e.age}</td>
                <td style={{ border: "1px solid", padding: "1%" }}>
                  <Button
                    onClick={() => {
                      const id = e._id;
